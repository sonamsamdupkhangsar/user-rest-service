...
public class LivenessReadinessRouter {
    ...
    public RouterFunction<ServerResponse> route(LivenessReadinessHandler livenessReadinessHandler) {
        ...
        return RouterFunctions.route(GET("/users/api/health/liveness").and(accept(MediaType.APPLICATION_JSON)),
                livenessReadinessHandler::liveness)
                .andRoute(GET("/users/api/health/readiness").and(accept(MediaType.APPLICATION_JSON)),
